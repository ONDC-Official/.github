...
|---------------------|---------------------------------|------------------|------------------------|----------|------|
|**IGM**|[Developer Guide v2.0.0](https://ondc-official.github.io/ONDC-NTS-Specifications/) `select version: draft-igm-2.0.0` <br/> **IGM v1.0.0 is deprecated**|[Test case scenarios - IGM 2.0](https://docs.google.com/document/d/1SGTCSzxNPtBvBpvtYf0I-MUxQCrYT_I-/edit#heading=h.v8et0hy8s5k1)|NA|[Refer to this document for testing](https://docs.google.com/document/d/1SGTCSzxNPtBvBpvtYf0I-MUxQCrYT_I-/edit#heading=h.9w30xhcg1m38)|[IGM FAQs](https://docs.google.com/document/d/1-NULesI1Z6GQ9y4Z0loGEG5yfunX5u9woON-qxYH6w0/edit)|
|**RSF**|[Developer Guide v2.0.0](https://ondc-official.github.io/ONDC-NTS-Specifications/) `select version: draft-rsf-2.0.0` <br/> **RSF v1.0.0 is deprecated**|[Test case scenarios - RSF 2.0](https://docs.google.com/document/d/1rHmQ8joTsT2HDmZdXhPlUKy5QSrJiQuEkTAjLDcNVoA/edit?pli=1&tab=t.0#heading=h.5vjft1c1kj0t)|[Refer to this document for testing](https://docs.google.com/document/d/1rHmQ8joTsT2HDmZdXhPlUKy5QSrJiQuEkTAjLDcNVoA/edit?pli=1&tab=t.0#heading=h.58rk098qk22i)|NA|[RSF FAQs](https://docs.google.com/document/d/19TCvuwwvOklt9Ev-SKkcXRAdvh6Qyhl9tI1Z_YavHMk/edit)|
...
|                   | Marine Insurance  | [https://cornex.in](https://cornex.in)                         | Fill onboarding form or Email "avijeet@cornex.in" for onboarding.                                                       | [https://ondc-ref-app.sequelstring.com/staging/mock/seller](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | -                                                                                                                         |
|                   | Motor Insurance   | [https://cornex.in](https://cornex.in)                         | Fill onboarding form or Email "avijeet@cornex.in" for onboarding.                                                       | [https://ondc-ref-app.sequelstring.com/staging/mock/seller](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | -                                                                                                                         |
|                   | Health Insurance  | [https://credit.staging.cliniq360.com/](https://credit.staging.cliniq360.com/) | Email "dev@cliniq360.com" to get the login credentials                                                                 | [https://ondc-ref-app.sequelstring.com/staging/mock/seller](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | -                                                                                                                         |

### Mobility
| Domain     | Service Type     | Buyer App                                                     | Onboarding Process/Point of Contact                                                                                                                                           | Seller App                       | Onboarding Process/Point of Contact                                                                                       |
|------------|------------------|--------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|---------------------------------------------------------------------------------------------------------------------------|
| Mobility   | Ride Hailing     | [https://ondc-ref-app.sequelstring.com/staging/gui/buyer](https://ondc-ref-app.sequelstring.com/staging/gui/buyer) | Process for NP to access the environment: <br> Please send the following info on email, please write to Mrityunjay and keep amit and nirdosh in cc: <ul><li>Email ID</li><li>Subscribe ID</li><li>NP Mobile Number</li><li>Role: BPP/BAP</li><li>Environment: Staging/Preprod</li></ul> Once Sequelstring receive the details, Sequelstring will assign a resource from our team who will be responsible for coordination and ensuring the success of the NP throughout their journey with our solutions. | [https://ondc-ref-app.sequelstring.com/staging/mock/seller](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | For Support, please refer to the details below: <br> **Mrityunjay Kumar** <ul><li>Email: mrityunjay.kumar@sequelstring.com</li></ul> **Nirdosh** <ul><li>Email: nirdosh.kumar@sequelstring.com</li></ul> **Amit** <ul><li>Email: amit.sharma@sequelstring.com</li></ul>  |
|            | Metro            | [https://ondc-ref-app.sequelstring.com/staging/gui/buyer](https://ondc-ref-app.sequelstring.com/staging/gui/buyer) | Process for NP to access the environment: <br> Please send the following info on email, please write to Mrityunjay and keep amit and nirdosh in cc: <ul><li>Email ID</li><li>Subscribe ID</li><li>NP Mobile Number</li><li>Role: BPP/BAP</li><li>Environment: Staging/Preprod</li></ul> Once Sequelstring receive the details, Sequelstring will assign a resource from our team who will be responsible for coordination and ensuring the success of the NP throughout their journey with our solutions. | [https://ondc-ref-app.sequelstring.com/staging/mock/seller](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | For Support, please refer to the details below: <br> **Mrityunjay Kumar** <ul><li>Email: mrityunjay.kumar@sequelstring.com</li></ul> **Nirdosh** <ul><li>Email: nirdosh.kumar@sequelstring.com</li></ul> **Amit** <ul><li>Email: amit.sharma@sequelstring.com</li></ul>  |

### B2B
| Domain  | Service Type | Buyer App                                                      | Onboarding Process/Point of Contact                                                                                   | Seller App                       | Onboarding Process/Point of Contact                                                                                       |
|---------|--------------|---------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|----------------------------------|---------------------------------------------------------------------------------------------------------------------------|
| B2B     | Retail       | [https://play.google.com/store/apps/details?id=com.placeorder.app.referance.preprod&pcampaignid=web_share](https://play.google.com/store/apps/details?id=com.placeorder.app.referance.preprod&pcampaignid=web_share) | Email "sanu.shilshad@acelrtech.com" OR "vishnudas.kt@acelrtech.com" to get the login details. Support Contact from Acelr Tech Labs Pvt. Ltd. (Rapidor) <ul><li>Name: Sanu Shilshad</li><li>Email: sanu.shilshad@acelrtech.com</li></ul> | ondc.sellerstagingref.rapidor.co | Email "sanu.shilshad@acelrtech.com" OR "vishnudas.kt@acelrtech.com" to get the login details. |

### B2C
| Domain  | Service Type | Buyer App                                                      | Onboarding Process/Point of Contact                                                                                   | Seller App                       | Onboarding Process/Point of Contact                                                                                       |
|---------|--------------|---------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|----------------------------------|---------------------------------------------------------------------------------------------------------------------------|
| B2C     | Logistics    | -                                                             | [https://ref-logistics-staging.thewitslab.com/](https://ref-logistics-staging.thewitslab.com/) | Email "ishan.dutta@thewitslab.com" to get the login credentials.                                                                  | -                                | -                                                                                                                         |
|         | Retail       | [https://ref-app-buyer-staging-v2.ondc.org/login](https://ref-app-buyer-staging-v2.ondc.org/login)   | Email "techsupport@ondc.org" to get the required support. | [https://ref-app-seller-staging-v2.ondc.org/sign-up](https://ref-app-seller-staging-v2.ondc.org/sign-up) | Email "techsupport@ondc.org" to get the required support.                                                                  |
